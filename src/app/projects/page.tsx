...
const projects = [
  ...
  {
    name: 'Cordelia',
    description: 'An Agentic AI Legal tech product for estate management & planning. A series of AI Agents to help you take care of your estate and those you love..',
    link: {
