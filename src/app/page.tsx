...
import logoForumVentures from '@/images/logos/formVenturesLogo.jpeg'
import logoUN from '@/images/logos/unLogo.png'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'TD Bank HQ',
      title: 'Full-Stack Engineer - ML Space',
      logo: logoTD,
      start: '2018',
      end: '2019',
    },
    {
      ...
      title: 'Front-end Developer - PCS4Kids',
      logo: logoUN,
      start: '2017',
      end: '2017',
    },
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/broderickwaun/"
